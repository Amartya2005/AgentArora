...
function _nextId() {
  if (_counter >= 999999) throw new Error("Element ID space exhausted");
  _counter += 1;
  const padded = String(_counter).padStart(3, "0");
  return "EL_" + padded;
}
...
function _isVisible(el) {
  ...
  // Check the element and its ancestors, including an open shadow host.
